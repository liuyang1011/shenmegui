...
<<<<<<< HEAD
    <fieldset>
        ...
        <table border="0" cellspacing="0" cellpadding="0" heigth="auto">
            <tr>
                <th>元数据名称</th>
                <td><input class="easyui-textbox" type="text" style="width:100px" name="metadataId" id="metadataId">
                </td>
                <th>中文名称</th>
                ...
                <td style="display:none"><input class="easyui-textbox" type="text" style="width:100px"
                                                name="metadataAlias" id="metadataAlias">
                </td>
                <th>类别词</th>
            ...
            <tr>
                ...
                <td align="right">
                    <a href="#" id="clean" onclick="$('#searchForm').form('clear');" class="easyui-linkbutton"
                       iconCls="icon-search" style="margin-left:1em">清空</a>
                <td align="right">
