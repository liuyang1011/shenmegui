                    ...
                    onClick: function (node) {
                        if (node.click == 'system') {
                            ...
                            if ($('#mainContentTabs').tabs('exists', title)) {
                                ...
                                var content = '<iframe scrolling="yes" frameborder="0"  src="' + LOAD_URL.SYSTEMINDEX + '" style="width:100%;height:98%;"></iframe>';
                                $('#mainContentTabs').tabs('add', {
                                    title: title,
                                    content: content,
                                    closable: true
                            ...
                            if ($('#mainContentTabs').tabs('exists', title)) {
                                ...
                                var content = '<iframe scrolling="yes" frameborder="0"  src="' + LOAD_URL.INTERFACELIST + '?systemId=' + mid + '" style="width:100%;height:98%;"></iframe>';
                                $('#mainContentTabs').tabs('add', {
                                    title: title,
                                    content: content,
                                    closable: true
                            ...
                            if ($('#mainContentTabs').tabs('exists', title)) {
                                ...
                                var content = '<iframe scrolling="yes" frameborder="0"  src="/jsp/sysadmin/system_protocol.jsp?protocolId=' + mid + '"  style="width:100%;height:98%;"></iframe>';
                                $('#mainContentTabs').tabs('add', {
                                    title: title,
                                    content: content,
                                    closable: true
                            ...
                            if ($('#mainContentTabs').tabs('exists', title)) {
                                ...
                                var content = '<iframe scrolling="yes" frameborder="0"  src="/jsp/sysadmin/file_list.jsp?systemId=' + node.id + '"  style="width:100%;height:98%;"></iframe>';
                                $('#mainContentTabs').tabs('add', {
                                    title: title,
                                    content: content,
                                    closable: true
                            ...
                            if ($('#mainContentTabs').tabs('exists', title)) {
                                ...
                                var content = '<iframe scrolling="yes" frameborder="0"  src="' + LOAD_URL.INTERFACEDEFINE + '?interfaceId=' + mid + '" style="width:100%;height:98%;"></iframe>';
                                $('#mainContentTabs').tabs('add', {
                                    title: title,
                                    content: content,
                                    closable: true
                    ...
                    onClick: function (node) {
                        if (typeof(node.children) == 'undefined') {
                            ...
                            if ($('#mainContentTabs').tabs('exists', title)) {
                                ...
                                var content = '<iframe scrolling="yes" frameborder="0"  src="/jsp/serviceLink/index.jsp?systemId=' + node.id + '" style="width:100%;height:98%;"></iframe>';
                                $('#mainContentTabs').tabs('add', {
                                    title: title,
                                    content: content,
                                    closable: true
                ...
                $('.mxservicetree').tree({
                    ...
                    onClick: function (node) {
                        if (node.type == 'root') {
                            return;
                            var title = "服务检索";
                            var content = '<iframe scrolling="yes"  name="searchFrame" id="searchFrame" frameborder="0"  src="' + LOAD_URL.SEARCH + '" style="width:100%;height:98%;"></iframe>';
                            if ($('#mainContentTabs').tabs('exists', title)) {
                                $('#mainContentTabs').tabs('select', title);
                            } else {
                                $('#mainContentTabs').tabs('add', {
                            ...
                            if ($("#serviceFrame" + node.id).size() == 0) {//如果没有打开基本信息，则新创建基本信息
                                ...
                                if ($('#mainContentTabs').tabs('exists', title)) {
                                    ...
                                    var content = '<iframe scrolling="yes"  name="serviceFrame' + node.id + '" id="serviceFrame' + node.id + '" frameborder="0"  src="' + LOAD_URL.SERVICEUI_LW + "?serviceId=" + node.id + '" style="width:100%;height:98%;"></iframe>';
                                    $('#mainContentTabs').tabs('add', {
                                        title: title,
                                        content: content,
                                        closable: true
...
var SYSTABMENU = {
    ...
    checkRule: function (mid) {
        $.post(LOAD_URL.CHECKRULE, 'mid=' + mid + '&t=' + new Date().getTime(), function (result) {
            ...
            if (result.success) {
                var content = '<iframe scrolling="yes" frameborder="0"  src="' + result.url + '" style="width:100%;height:98%;"></iframe>';
                $('#mainContentTabs').tabs('add', {
                    title: result.title,
                    content: content,
                    closable: true
