...
<script type="text/javascript">
  ...
  $('#saveBtn').click(function () {
    ...
    var orgNameValue = $('#orgName3').val();
    if(oldOrgName==orgNameValue){
      hasOrgName = false;
    } else{
      ...
      if(hasOrgName){
        alert("该机构名称已存在");
          ...
          $.ajax({
            ...
            url: "/org/modify/" + encodeURI(encodeURI(oldOrgName)),
...
//        organizationManager.modify(data, function (result) {
//          if (result) {
//            alert("保存成功");
//            $('#w').window('close');
//            $('#orgTab').datagrid('reload');
