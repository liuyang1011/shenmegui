    ...
    <fieldset>
        ...
        <table border="0" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <th>接口功能描述</th>
                <td><input name="interfaceId" id="interfaceDesc" class="easyui-textbox" style="width:150px"/>
                </td>
                <th></th>
                <td>
                </td>
            ...
            <tr>
                ...
                <th>提供者</th>
                <td><input name="providerId" id="providerId" class="easyui-combobox" style="width:150pxt"
                           data-options="
                 method:'get',
                 url:'/system/getSystemAll',
                 textField:'chineseName',
