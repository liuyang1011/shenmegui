...
<form class="easyui-form" id="exportForm">
    ...
    <table id="choosedList" class="easyui-datagrid"
        ...
        <tr>
            ...
            <th data-options="field:'conTranCode',hidden:true">交易码</th>
    ...
    function tranToEsb() {
        ...
        if (null != rows && 0 < rows.length) {
            ...
            for (var i = 0; i < rows.length; i++) {
                ...
                configVO.consumerName = rows[i].consumerName;
                configVO.conInterfaceName = rows[i].conInterfaceName;
                configVO.conGeneratorName = rows[i].conGeneratorName;
                configVO.serviceId = serviceId
                configVO.operationId = operationId;
                configVO.conTranCode = rows[i].conTranCode;
