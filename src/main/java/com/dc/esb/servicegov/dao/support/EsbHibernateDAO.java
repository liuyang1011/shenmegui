...
public class EsbHibernateDAO<T, PK extends Serializable> {
     ...
     */
    public EsbHibernateDAO(final SessionFactory sessionFactory, final Class<T> entityClass) {
