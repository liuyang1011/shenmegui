 ...
 */
public class ExportConfigOutReqTask implements Runnable{
    private static final Log logger = LogFactory.getLog(ExportConfigOutReqTask.class);
    ...
    public void run(){
        configExportGenerator.generateOutRequest(serviceInvokesIn, path);
        countDown.countDown();
    }
}
