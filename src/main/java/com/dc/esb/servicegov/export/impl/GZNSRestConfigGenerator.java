 ...
 */
public class GZNSRestConfigGenerator implements IMetadataConfigGenerator {
    ...
    public File generatorIn(List<Ida> idas, List<SDA> sdas, ExportBean export) {
        if(idas != null){
            ...
            com.dc.esb.servicegov.entity.System consumer_system = systemService.getById(export.getConsumerSystemId());
