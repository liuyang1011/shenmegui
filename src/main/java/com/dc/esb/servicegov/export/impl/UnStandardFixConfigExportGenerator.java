 ...
 */
@Component
public class UnStandardFixConfigExportGenerator extends ConfigExportGenerator{
    private Log log = LogFactory.getLog(UnStandardFixConfigExportGenerator.class);
    ...
    public void  generateRequest(ServiceInvoke serviceInvoke, String path){
        try {
            ...
            if(null != inter) {
                ...
                Element serviceElement = doc.addElement("fixmessage");//根节点
