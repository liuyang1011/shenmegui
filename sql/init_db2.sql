...
INSERT INTO GENERATOR (ID, DESCRIPTION, IMPLEMENTS, NAME) VALUES ('0', '默认的XML标准的拆组包生成器', 'com.dc.esb.servicegov.export.impl.StandardXMLConfigExportGender', 'XML标准拆组包生成器');
INSERT INTO GENERATOR (ID, DESCRIPTION, IMPLEMENTS, NAME) VALUES ('1', 'XML非标准的拆组包生成器', 'com.dc.esb.servicegov.export.impl.UnStandardXMLConfigExportGender', 'XML非标拆组包生成器');
